                                ...
                                >
                                        ...
                                        <div className="ml-3">
                                            <h5 className="font-weight-semibold mb-0">
                                                ...
                                                <span className="text-danger font-size-sm font-weight-normal">
                                                    <i className="icon-arrow-down12" /> (-4.9%)
                                                </span>
                                            </h5>
                                    ...
                                    <div>
                                        <a href="!#" className="btn btn-indigo">
                                            <i className="icon-statistics mr-2" /> View report
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="mr-3">
                                                            <a href="!#">
                                                                <img
                                                                    src="../../../../global_assets/images/brands/facebook.svg"
                                                ...
                                                <td>
                                                    <span className="text-success">
                                                        <i className="icon-stats-growth2 mr-2" />{' '}
                                                        2.43%
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="mr-3">
                                                            <a href="!#">
                                                                <img
                                                                    src="../../../../global_assets/images/brands/youtube.svg"
                                                                    className="rounded-circle"
                                                                    width="32"
                                                                    height="32"
                                                                    alt=""
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="mr-3">
                                                            <a href="!#">
                                                                <img
                                                                    src="../../../../global_assets/images/brands/spotify.svg"
                                                                    className="rounded-circle"
                                                                    width="32"
                                                                    height="32"
                                                                    alt=""
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="text-muted font-size-sm">
                                                                <span className="badge badge-mark border-secondary mr-1" />
                                                                10:00 - 11:00
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    <span className="text-danger">
                                                        <i className="icon-stats-decline2 mr-2" /> -
                                                        8.02%
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="mr-3">
                                                            <a href="!#">
                                                                <img
                                                                    src="../../../../global_assets/images/brands/twitter.svg"
                                                                    className="rounded-circle"
                                                                    width="32"
                                                                    height="32"
                                                                    alt=""
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="mr-3">
                                                            <a href="!#">
                                                                <img
                                                                    src="../../../../global_assets/images/brands/bing.svg"
                                                                    className="rounded-circle"
                                                                    width="32"
                                                                    height="32"
                                                                    alt=""
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="mr-3">
                                                            <a href="!#">
                                                                <img
                                                                    src="../../../../global_assets/images/brands/amazon.svg"
                                                                    className="rounded-circle"
                                                                    width="32"
                                                                    height="32"
                                                                    alt=""
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="mr-3">
                                                            <a href="!#">
                                                                <img
                                                                    src="../../../../global_assets/images/brands/dribbble.svg"
                                                                    className="rounded-circle"
                                                                    width="32"
                                                                    height="32"
                                                                    alt=""
                                                ...
                                                <div className="list-icons ml-auto">
                                                    <div className="dropdown">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a href="!#" className="dropdown-item">
                                                                <i className="icon-pie5" />{' '}
                                                                Statistics
                                                            </a>
                                                            <a href="!#" className="dropdown-item">
                                                                <i className="icon-cross3" /> Clear
                                                                list
                                                            </a>
                                                        </div>
                                                    </div>
                      ...
                      "
                                ...
                                "
                                                ...
                                                <td>
                                                    <a href="!#" className="text-body">
                                                        <div className="font-weight-semibold">
                                                            [#1183] Workaround for OS X selects
                                                            printing bug
                                                        </div>
                                                        <span className="text-muted">
                                                            Chrome fixed the bug several versions
                                                            ago, thus rendering this...
                                                        </span>
                                                    </a>
                                                </td>
                                                <td className="text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="!#" className="text-body">
                                                        <div className="font-weight-semibold">
                                                            [#1249] Vertically center carousel
                                                            controls
                                                        </div>
                                                        <span className="text-muted">
                                ...
                                "
                                                ...
                                                <td>
                                                    <a href="!#" className="text-body">
                                                        <div className="font-weight-semibold">
                                                            [#1254] Inaccurate small pagination
                                                            height
                                                        </div>
                                                        <span className="text-muted">
                                ...
                                "
                                                ...
                                                <td>
                                                    <a href="!#" className="text-body">
                                                        <div className="font-weight-semibold">
                                                            [#1184] Round grid column gutter
                                                            operations
                                                        </div>
                                                        <span className="text-muted">
                                                            Left rounds up, right rounds down.
                                ...
                                "
                                                ...
                                                <td>
                                                    <a href="!#" className="text-body">
                                                        <div>
                                                            [#1046] Avoid some unnecessary HTML
                                                            string
                                                        </div>
                                                        <span className="text-muted">
                                                            Rather than building a string of HTML
                                                            and then parsing it...
                                                        </span>
                                                    </a>
                                                </td>
                                                        ...
                                                        <div className="dropdown">
                                                            ...
                                                            <div className="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a
                                                                    ...
                                                                    className="dropdown-item"
                                                                >
                                                                    <i className="icon-plus3 text-primary" />
                                                                    Unresolve issue
                                                                </a>
                                                                <a
                                                                    href="!#"
                                ...
                                "
                                                ...
                                                <td>
                                                    <a href="!#" className="text-body">
                                                        ...
                                                        <span className="text-muted">
                                                            The <code>files</code> property is
                                                            necessary to override the files
                                                            property...
                                                        </span>
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="!#" className="text-body">
                                                        <div>
                                                            [#1040] Account for static form controls
                                                            in form group
                                                        </div>
                                                        <span className="text-muted">
                                                            Resizes control label&apos;s font-size
                                                            and account for the standard...
                                                        </span>
                                                    </a>
                                                </td>
                                                <td className="text-center">
                                                        ...
                                                        <div className="dropdown">
                                                            ...
                                                            <div className="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a
                                                                    ...
                                                                    className="dropdown-item"
                                                                >
                                                                    <i className="icon-spinner11 text-success" />
                                                                    Reopen issue
                                                                </a>
                                                            </div>
                                                        </div>
                                ...
                                "
                                                ...
                                                <td>
                                                    <a href="!#" className="text-body">
                                                        <div>
                                                            [#1038] Proper sizing of form control
                                                            feedback
                                                        </div>
                                                        <span className="text-muted">
                                                            Feedback icon sizing inside a
                                                            larger/smaller form-group...
                                                        </span>
                                                    </a>
                                                </td>
                                                <td className="text-center">
                                                    ...
                                                    <div className="card-img-actions">
                                                        <a href="!#">
                                                            <img
                                                                ...
                                                                alt=""
                                                            />
                                                            <span className="card-img-actions-overlay card-img">
                                                                <i className="icon-play3 icon-2x" />
                                                            </span>
                                                        </a>
                                                    </div>
                                                </div>
                            ...
                            "
                                                    >
                                                        <li className="list-inline-item">
                                                            <i className="icon-book-play mr-2" />{' '}
                                                            Video tutorials
                                                        </li>
                                                    </ul>
                                                    The him father parish looked has sooner.
                                                    Attachment frequently terminated son hello...
                                                </div>
                                            </div>
                                            ...
                                            <div className="media flex-column flex-sm-row mt-0 mb-3">
                                                <div className="mr-sm-3 mb-2 mb-sm-0">
                                                    <div className="card-img-actions">
                                                        <a href="!#">
                                                            <img
                                                                src="../../../../global_assets/images/demo/flat/21.png"
                                                                className="img-fluid img-preview rounded"
                                                                alt=""
                                                            />
                                                            <span className="card-img-actions-overlay card-img">
                                            ...
                                            <div className="media flex-column flex-sm-row mt-0 mb-3">
                                                <div className="mr-sm-3 mb-2 mb-sm-0">
                                                    <div className="card-img-actions">
                                                        <a href="!#">
                                                            <img
                                                                src="../../../../global_assets/images/demo/flat/12.png"
                                                                className="img-fluid img-preview rounded"
                                                                alt=""
                                                            />
                                                            <span className="card-img-actions-overlay card-img">
                                            ...
                                            <div className="media flex-column flex-sm-row mt-0 mb-3">
                                                <div className="mr-sm-3 mb-2 mb-sm-0">
                                                    <div className="card-img-actions">
                                                        <a href="!#">
                                                            <img
                                                                src="../../../../global_assets/images/demo/flat/15.png"
                                                                className="img-fluid img-preview rounded"
                                                                alt=""
                                                            />
                                                            <span className="card-img-actions-overlay card-img">
                        ...
                        <div className="col-xl-4">
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <div className="card text-center">
                                        <div className="card-body">
                                            {/* Progress counter */}
                                            <div
                                                className="svg-center position-relative"
                            ...
                            <div className="card">
                                <div className="card-header header-elements-inline">
                                    ...
                                    <div className="header-elements">
                                        <span>
                                            <i className="icon-history text-warning mr-2" /> Jul 7,
                                            10:30
                                        </span>
                                        <span className="badge badge-success align-self-start ml-3">
                                            Online
                                        </span>
                                    </div>
                                </div>
                                        ...
                                        <ul className="media-list">
                                            <li className="media">
                                                <div className="mr-3 position-relative">
                                                    ...
                                                    <span
                                                        className="
                              badge badge-danger badge-pill badge-float
                      ...
                      "
                                        ...
                                        >
                                            <input
                                                ...
                                                checked
                                            />
                                            <span className="custom-control-label">Realtime</span>
                                        </label>
                                        <span className="badge badge-danger badge-pill">+86</span>
                                    </div>
                                </div>
